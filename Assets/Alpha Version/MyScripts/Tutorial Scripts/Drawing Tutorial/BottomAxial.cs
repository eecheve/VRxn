...
public class BottomAxial : MonoBehaviour
{
    [SerializeField] private BottomAxialManager pointsManager = null;
    ...
    private void AssignIconToVertexBottom(Collider other)
    {
        ...
        {
            Icon.ChangeTag();
            Icon.BottomAxial = this;
            Icon.BottomAxialManager = pointsManager;
        }
